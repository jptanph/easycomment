...
class frontPageTemplate extends Controller_Front
{
    ...
    protected function run($aArgs)
    {
        ...
        for($i = 1;  $i < 10 ; $i++)
        {
            ...
            $sHtml .= "                    <label>Password : </label><input type='password' /> <p class='expandable_btn' style='border-bottom:none;display:visible;' id='{$sPrefix}send'><a href='#none' onclick='frontPageEasycomment.execSaveComment();'><span>Delete</span></a></p>";
            $sHtml .= "                </div>\n";
            $sHtml .= "            </li>\n";
        }
        ...
        $sHtml .= "		       <p><label>Name : </label><input type='text'></p>\n";
        $sHtml .= "		       <p><label>Comment : </label><textarea></textarea></p>\n";
        $sHtml .= "		       <p><label>Password : </label><input type='password'></p>\n";
        $sHtml .= "		       <p><label>Captcha : </label><span>SASDASDASDASDASD</span></p>\n";
        $sHtml .= "		       <p><label>Enter Captcha : </label><input type='text'></p>\n";
